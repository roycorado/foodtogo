			...
			<div class="col-sm-8 offset-sm-2">
				<form action = "../controllers/process_edit_item.php" method="POST">
					...
					<div class="form-group">
						...
						<textarea class="from-control col-8" name="description" id="description" rows"5"><?php echo $item['description']; ?>
						</textarea> 
					</div>
					<div class="form-grout">
						<label for="categories"> Categories </label>
						<select class="from-control col-8" name="category_id" id="category" required>
							<?php
